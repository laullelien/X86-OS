...
#define NB_TEST_CASE 16
static int size = NB_TEST_CASE;                 /*Mark null to not execute the test case*/
static int (*test_case[NB_TEST_CASE])(void *) = {test0, test1, test2, test3, test4, test5, test6, NULL, test8, NULL, test10, NULL, test12,test13,test14,test15};
